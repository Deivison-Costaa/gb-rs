...
<!-- fonte: src/Joypad_Input.md @ fe246067b695 -->
...
_Fonte desta seção: [`src/Joypad_Input.md`](https://github.com/gbdev/pandocs/blob/fe246067b695b5404a4a6a47efb4fd6d921ececb/src/Joypad_Input.md)_


---

<!-- fonte: src/Serial_Data_Transfer_(Link_Cable).md @ fe246067b695 -->
...
**`Initially`** — layout de bits (8 bits):
...
that the transfer is complete in two ways: SC's Bit 7 will be cleared, and a [Serial interrupt](https://gbdev.io/pandocs/single.html#int-58--serial-interrupt)
...
Game Boy will have a [serial interrupt](https://gbdev.io/pandocs/single.html#int-58--serial-interrupt) requested at the end of the
...
_Fonte desta seção: [`src/Serial_Data_Transfer_(Link_Cable).md`](https://github.com/gbdev/pandocs/blob/fe246067b695b5404a4a6a47efb4fd6d921ececb/src/Serial_Data_Transfer_(Link_Cable).md)_
